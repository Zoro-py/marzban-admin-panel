...
interface StatCardProps {
  ...
  /** A short explanatory line under the value — for a figure that's real but
   * easy to misread in isolation (e.g. a non-zero "not yet invoiced" amount
   * that's already fully covered by existing credit). Not a tooltip: the
   * point is to answer "why is this here" without requiring a hover. */
  hint?: string
  className?: string
}
...
export function StatCard({ label, value, tone = 'default', secondary, hint, className }: StatCardProps) {
  return (
